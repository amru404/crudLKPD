                    ...
                    <div class="align-items-center justify-content-between mb-4">
                        ...
                        <form action="{{route('blog.store')}}" method="post">
                            <div class="mb-3" style="margin-top: 70px">
                                ...
                                <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="gambar" style=" height:45px">
                            </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="konten">
                        </div>
