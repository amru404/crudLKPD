...
<body id="page-top">
    ...
    <a href="{{route ('blog.index')}}" class="btn btn-secondary" style=" margin-bottom:20px; float:right;">Back</a>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12" style="margin-top: 70px">
                    <div class="form-group">
                        ...
                        <input type="file" name="gambar" value="{{ $blogs->gambar }}" class="form-control" placeholder="gambar" style="height: 45px">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="konten" value="{{ $blogs->konten }}" class="form-control" placeholder="konten">
                    </div>
                </div>
